import 'package:antarmitra/screens/gemini_chat/message.dart';
  ...
  callGeminiModel() async {
    try {
      if (_controller.text.isNotEmpty) {
        _messages.add(Messages(text: _controller.text, isUser: true));
        _isLoading = true;
      }

      final model = GenerativeModel(
          model: 'gemini-pro', apiKey: dotenv.get('GOOGLE_API_KEY'));
